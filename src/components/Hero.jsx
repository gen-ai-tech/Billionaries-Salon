...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-[100dvh] lg:min-h-screen overflow-hidden bg-[#050505] flex flex-col justify-start lg:justify-center pt-64 lg:pt-0 pb-12 lg:py-0">
      {/* Background Glows */}
      ...
      <div className="container-premium relative z-10 w-full flex-grow flex flex-col justify-start lg:justify-center mt-20 lg:mt-0">
